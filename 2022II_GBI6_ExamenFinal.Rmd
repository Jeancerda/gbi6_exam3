...
En la grafiaca anterior se observo que en las columnas se encuentran las isla1 isla2 isla 3 y en las filas superiores se encuentran el tipo de sexo1 sexo2 sexo3 lo que representa una diagrama de regresion entre islas y sexo

###  l\*\* \*\*[3.0 puntos] 1.2. Genere dos gráficas `p4` y `p5`donde:
